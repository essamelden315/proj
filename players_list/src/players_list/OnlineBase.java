...
public class OnlineBase extends AnchorPane {
    ...
    public OnlineBase(Stage stage) {
        ...
        getStylesheets().add("/players_list/GameStyle.css");
        ...
        onBtn1.getStylesheets().add("/players_list/GameStyle.css");
        ...
        onBtn2.setStyle("-fx-background-image: black;");
        onBtn2.getStyleClass().add("bleBtn");
        onBtn2.getStylesheets().add("/players_list/GameStyle.css");
        ...
        onBtn3.getStylesheets().add("/players_list/GameStyle.css");
        ...
        onBtn4.getStylesheets().add("/players_list/GameStyle.css");
        ...
        onLabel.getStylesheets().add("/players_list/GameStyle.css");
        onLabel.setText("Online");

        btnImg1.setFitHeight(66.0);
        ...
        btnImg1.getStyleClass().add("bleBtn");
        btnImg1.setImage(new Image(getClass().getResource("photos/boy.jpeg").toExternalForm()));
        ...
        btnImg2.setImage(new Image(getClass().getResource("photos/girl.jpeg").toExternalForm()));
        ...
        btnImg3.setImage(new Image(getClass().getResource("photos/boy.jpeg").toExternalForm()));
        ...
        btnImg4.getStyleClass().add("btnImg4");
        btnImg4.setImage(new Image(getClass().getResource("photos/girl.jpeg").toExternalForm()));
        ...
        backBtn.getStylesheets().add("/players_list/GameStyle.css");
